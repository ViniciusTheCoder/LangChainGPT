...
const CONDENSE_PROMPT = ` Dada uma pegunta realizada pelo usuário, reformule-a para se tornar uma pergunta isolada, mas sem deixar de considerar o histórico da conversa
